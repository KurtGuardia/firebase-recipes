...
const BASE_URL =
  process.env.REACT_APP_CLOUD_FIRESTORE_FUNCTION_API_URL
...
const readDcoments = async ({
  ...
  try {
    ...
    for (const query of queries) {
      url.searchParams.append(query.dield, query.value)
    }
...
const deletDocument = async (collection, id) => {
  let token
